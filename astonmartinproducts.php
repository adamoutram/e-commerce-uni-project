...
JSFX_FloatDiv("menu", 10,30).floatIt();
		...
		<div id="content">
			...
			<br />
			<h2 align="center">Aston Martin Products</h2>
			<form name="sort" action="astonmartinproducts.php" method="post">
	 ...
	 $query = "SELECT * FROM products WHERE Brand = 'Aston Martin' ORDER BY ".$sort." DESC" or die(mysqli_error());

} else { // else if you do not pass any value from select option will return this
	    $query = "SELECT * FROM products WHERE Brand = 'Aston Martin'" or die(mysqli_error());
}
