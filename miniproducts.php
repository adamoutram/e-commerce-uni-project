...
<html lang="en">
	...
	<body>
		...
		<div id="content">
			...
			<br />
			<h2 align="center">Mini Products</h2>
			<form name="sort" action="miniproducts.php" method="post">
	 ...
	 $query = "SELECT * FROM products WHERE Brand = 'Mini' ORDER BY ".$sort." DESC" or die(mysqli_error());

} else { // else if you do not pass any value from select option will return this
	    $query = "SELECT * FROM products WHERE Brand = 'Mini'" or die(mysqli_error());
}
