...
<html lang="en">
	...
	<body>
		...
		<div id="content">
			...
			<br />
			<h2 align="center">Jaguar Products</h2>
			<form name="sort" action="jaguarproducts.php" method="post">
	 ...
	 $query = "SELECT * FROM products WHERE Brand = 'Jaguar' ORDER BY ".$sort." DESC" or die(mysqli_error());

} else { // else if you do not pass any value from select option will return this
	    $query = "SELECT * FROM products WHERE Brand = 'Jaguar'" or die(mysqli_error());
}
