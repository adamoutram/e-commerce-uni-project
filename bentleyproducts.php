...
<html lang="en">
	...
	<body>
		...
		<div id="content">
			...
			<br />
			<h2 align="center">Bentley Products</h2>
			<form name="sort" action="bentleyproducts.php" method="post">
	 ...
	 $query = "SELECT * FROM products WHERE Brand = 'Bentley' ORDER BY ".$sort." DESC" or die(mysqli_error());

} else { // else if you do not pass any value from select option will return this
	    $query = "SELECT * FROM products WHERE Brand = 'Bentley'" or die(mysqli_error());
}
