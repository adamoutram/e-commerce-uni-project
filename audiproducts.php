...
<html lang="en">
	...
	<body>
		...
		<div id="content">
			...
			<br />
			<h2 align="center">Audi Products</h2>
			<form name="sort" action="audiproducts.php" method="post">
	 ...
	 $query = "SELECT * FROM products WHERE Brand = 'Audi' ORDER BY ".$sort." DESC" or die(mysqli_error());

} else { // else if you do not pass any value from select option will return this
	    $query = "SELECT * FROM products WHERE Brand = 'Audi'" or die(mysqli_error());
}
